...
```{r}
saveRDS(object = locat_BOCD_ncp_send, file = "CP_Detection/locat_BOCD_ncp_send.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_ncp_diff, file = "CP_Detection/locat_BOCD_ncp_diff.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_ncp_ine, file = "CP_Detection/locat_BOCD_ncp_ine.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_ncp_out, file = "CP_Detection/locat_BOCD_ncp_out.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_ncp_send, file = "CP_Detection/locat_PELT_ncp_send.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_ncp_diff, file = "CP_Detection/locat_PELT_ncp_diff.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_ncp_ine, file = "CP_Detection/locat_PELT_ncp_ine.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_ncp_out, file = "CP_Detection/locat_PELT_ncp_out.RDS")
```
...
```{r}
saveRDS(object = locat_BS_ncp_send, file = "CP_Detection/locat_BS_ncp_send.RDS")
```
...
```{r}
saveRDS(object = locat_BS_ncp_diff, file = "CP_Detection/locat_BS_ncp_diff.RDS")
```
...
```{r}
saveRDS(object = locat_BS_ncp_ine, file = "CP_Detection/locat_BS_ncp_ine.RDS")
```
...
```{r}
saveRDS(object = locat_BS_ncp_out, file = "CP_Detection/locat_BS_ncp_out.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_1cp_send, file = "CP_Detection/locat_BOCD_1cp_send.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_1cp_diff, file = "CP_Detection/locat_BOCD_1cp_diff.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_1cp_ine, file = "CP_Detection/locat_BOCD_1cp_ine.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_1cp_out, file = "CP_Detection/locat_BOCD_1cp_out.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_1cp_send, file = "CP_Detection/locat_PELT_1cp_send.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_1cp_diff, file = "CP_Detection/locat_PELT_1cp_diff.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_1cp_ine, file = "CP_Detection/locat_PELT_1cp_ine.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_1cp_out, file = "CP_Detection/locat_PELT_1cp_out.RDS")
```
...
```{r}
saveRDS(object = locat_BS_1cp_send, file = "CP_Detection/locat_BS_1cp_send.RDS")
```
...
```{r}
saveRDS(object = locat_BS_1cp_diff, file = "CP_Detection/locat_BS_1cp_diff.RDS")
```
...
```{r}
saveRDS(object = locat_BS_1cp_ine, file = "CP_Detection/locat_BS_1cp_ine.RDS")
```
...
```{r}
saveRDS(object = locat_BS_1cp_out, file = "CP_Detection/locat_BS_1cp_out.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_1cp_send_same.all, file = "CP_Detection/locat_BOCD_1cp_send_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_1cp_diff_same.all, file = "CP_Detection/locat_BOCD_1cp_diff_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_1cp_ine_same.all, file = "CP_Detection/locat_BOCD_1cp_ine_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_1cp_out_same.all, file = "CP_Detection/locat_BOCD_1cp_out_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_1cp_send_same.all, file = "CP_Detection/locat_PELT_1cp_send_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_1cp_diff_same.all, file = "CP_Detection/locat_PELT_1cp_diff_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_1cp_ine_same.all, file = "CP_Detection/locat_PELT_1cp_ine_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_1cp_out_same.all, file = "CP_Detection/locat_PELT_1cp_out_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_BS_1cp_send_same.all, file = "CP_Detection/locat_BS_1cp_send_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_BS_1cp_diff_same.all, file = "CP_Detection/locat_BS_1cp_diff_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_BS_1cp_ine_same.all, file = "CP_Detection/locat_BS_1cp_ine_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_BS_1cp_out_same.all, file = "CP_Detection/locat_BS_1cp_out_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_2cp_send, file = "CP_Detection/locat_BOCD_2cp_send.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_2cp_diff, file = "CP_Detection/locat_BOCD_2cp_diff.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_2cp_ine, file = "CP_Detection/locat_BOCD_2cp_ine.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_2cp_out, file = "CP_Detection/locat_BOCD_2cp_out.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_2cp_send, file = "CP_Detection/locat_PELT_2cp_send.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_2cp_diff, file = "CP_Detection/locat_PELT_2cp_diff.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_2cp_ine, file = "CP_Detection/locat_PELT_2cp_ine.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_2cp_out, file = "CP_Detection/locat_PELT_2cp_out.RDS")
```
...
```{r}
saveRDS(object = locat_BS_2cp_send, file = "CP_Detection/locat_BS_2cp_send.RDS")
```
...
```{r}
saveRDS(object = locat_BS_2cp_diff, file = "CP_Detection/locat_BS_2cp_diff.RDS")
```
...
```{r}
saveRDS(object = locat_BS_2cp_ine, file = "CP_Detection/locat_BS_2cp_ine.RDS")
```
...
```{r}
saveRDS(object = locat_BS_2cp_out, file = "CP_Detection/locat_BS_2cp_out.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_2cp_send_same.all, file = "CP_Detection/locat_BOCD_2cp_send_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_2cp_diff_same.all, file = "CP_Detection/locat_BOCD_2cp_diff_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_2cp_ine_same.all, file = "CP_Detection/locat_BOCD_2cp_ine_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_BOCD_2cp_out_same.all, file = "CP_Detection/locat_BOCD_2cp_out_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_2cp_send_same.all, file = "CP_Detection/locat_PELT_2cp_send_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_2cp_diff_same.all, file = "CP_Detection/locat_PELT_2cp_diff_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_2cp_ine_same.all, file = "CP_Detection/locat_PELT_2cp_ine_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_PELT_2cp_out_same.all, file = "CP_Detection/locat_PELT_2cp_out_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_BS_2cp_send_same.all, file = "CP_Detection/locat_BS_2cp_send_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_BS_2cp_diff_same.all, file = "CP_Detection/locat_BS_2cp_diff_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_BS_2cp_ine_same.all, file = "CP_Detection/locat_BS_2cp_ine_same.all.RDS")
```
...
```{r}
saveRDS(object = locat_BS_2cp_out_same.all, file = "CP_Detection/locat_BS_2cp_out_same.all.RDS")
```
