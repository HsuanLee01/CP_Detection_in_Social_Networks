...
windows_ncp <- list()
for (i in 1:length(REH_NCP)) {
  windows_ncp[[i]] <- REHdynamics::createwindows(1000, tau[i], overlap = 1/2)
}
...
windows_1cp <- list()
for (i in 1:length(REH_1CP)) {
  windows_1cp[[i]] <- REHdynamics::createwindows(1000, tau[i], overlap = 1/2)
}
...
for (i in 1:length(REH_1CP_same.all)) {
  windows_1cp_same.all[[i]] <- REHdynamics::createwindows(1000, tau[i], overlap = 1/2)
}
...
for (i in 1:length(REH_1CP_diff.all)) {
  windows_1cp_diff.all[[i]] <- REHdynamics::createwindows(1000, tau[i], overlap = 1/2)
}
...
windows_2cp <- list()
for (i in 1:length(REH_2CP)) {
  windows_2cp[[i]] <- REHdynamics::createwindows(1000, tau[i], overlap = 1/2)
}
...
for (i in 1:length(REH_2CP_same.all)) {
  windows_2cp_same.all[[i]] <- REHdynamics::createwindows(1000, tau[i], overlap = 1/2)
}
...
for (i in 1:length(REH_2CP_diff.all)) {
  windows_2cp_diff.all[[i]] <- REHdynamics::createwindows(1000, tau[i], overlap = 1/2)
}
