...
mw_scketch %>%
  ...
  geom_segment(aes(x = as.POSIXct("01:00:00", format="%H:%M:%S"), y = 2, xend = as.POSIXct("03:00:00", format="%H:%M:%S"), yend = 2)) +
  geom_segment(aes(x = as.POSIXct("02:00:00", format="%H:%M:%S"), y = 3, xend = as.POSIXct("04:00:00", format="%H:%M:%S"), yend = 3)) +
  ...
  geom_segment(aes(x = as.POSIXct("01:00:00", format="%H:%M:%S"), y = 1, xend = as.POSIXct("01:00:00", format="%H:%M:%S"), yend = 2), 
  ...
  geom_segment(aes(x = as.POSIXct("02:00:00", format="%H:%M:%S"), y = 1, xend = as.POSIXct("02:00:00", format="%H:%M:%S"), yend = 2), 
               linetype = "dashed", color = brewer.pal(n = 7, name = "Set1")[1]) +
  geom_segment(aes(x = as.POSIXct("02:00:00", format="%H:%M:%S"), y = 2, xend = as.POSIXct("02:00:00", format="%H:%M:%S"), yend = 3), 
               linetype = "dashed", color = brewer.pal(n = 7, name = "Set1")[1]) +
  geom_segment(aes(x = as.POSIXct("03:00:00", format="%H:%M:%S"), y = 2, xend = as.POSIXct("03:00:00", format="%H:%M:%S"), yend = 3), 
               linetype = "dashed", color = brewer.pal(n = 7, name = "Set1")[1]) +
  ...
  geom_segment(aes(x = as.POSIXct("02:00:00", format="%H:%M:%S"), y = 0.9, xend = as.POSIXct("02:00:00", format="%H:%M:%S"), yend = 1.1), 
               linetype = "solid", color = "black") +
  geom_segment(aes(x = as.POSIXct("01:00:00", format="%H:%M:%S"), y = 1.9, xend = as.POSIXct("01:00:00", format="%H:%M:%S"), yend = 2.1), 
               linetype = "solid", color = "black") +
  geom_segment(aes(x = as.POSIXct("03:00:00", format="%H:%M:%S"), y = 1.9, xend = as.POSIXct("03:00:00", format="%H:%M:%S"), yend = 2.1), 
               linetype = "solid", color = "black") +
  geom_segment(aes(x = as.POSIXct("02:00:00", format="%H:%M:%S"), y = 2.9, xend = as.POSIXct("02:00:00", format="%H:%M:%S"), yend = 3.1), 
               linetype = "solid", color = "black") +
