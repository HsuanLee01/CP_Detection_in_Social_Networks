...
param.2cp_diff.all <- list(
  ...
  "z_send"= function(t) {
    # set the location of CP
    if(t < 21880) { # window 31, 32, 33
      0.2
    } else
      
      if(t < 44260) { # window 65, 66, 67
          -0.02
          } else {0.19}
    },
  ...
  "z_difference" = function(t) {
    # set the location of CP
    if(t < 18250) { # window 27, 28, 29
      -0.01
    } else
      
      if(t < 40710) { # window 60, 61, 62
          -0.13
          } else {0.03}
    },
  ...
  "outdegreeSender" = function(t) {
    # set the location of CP
    if(t < 26370) { # window 38, 39, 40
      -0.01
      } else
        
        if(t < 54000) { # window 80, 81, 82
          0.15
          } else {-0.01}
    }
)
