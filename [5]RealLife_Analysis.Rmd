...
inertia_cpd.plot <- 
  ...
  geom_point(color = brewer.pal(n = 7, name = "Set1")[2], size = 1.05) +
  labs(title = "Inertia",
       x = "Window", 
       y = "Parameter") +
  theme_bw() +
...
outdegree_cpd.plot <- 
  ...
  geom_point(color = brewer.pal(n = 7, name = "Set1")[3], size = 1.05) +
...
indegreeReceiver_cpd.plot <- 
  ...
  geom_point(color = brewer.pal(n = 7, name = "Set1")[1], size = 1.05) +
...
totSender_cpd.plot <- 
  ...
  geom_point(color = brewer.pal(n = 7, name = "Set1")[7], size = 1.05) +
...
psABBA_cpd.plot <- 
  ...
  geom_point(color = brewer.pal(n = 7, name = "Set1")[4], size = 1.05) +
  labs(title = "psABBA",
       x = "Window", 
       y = "Parameter") +
  theme_bw() +
...
psABXA_cpd.plot <- 
  ...
  geom_point(color = "#FFD301", size = 1.05) +
  labs(title = "psABXA",
       x = "Window", 
       y = "Parameter") +
  theme_bw() +
...
psABBY_cpd.plot <- 
  ...
  geom_point(color = brewer.pal(n = 7, name = "Set1")[5], size = 1.05) +
  labs(title = "psABBY",
       x = "Window", 
       y = "Parameter") +
  theme_bw() +
