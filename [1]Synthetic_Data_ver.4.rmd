...
formula <- ~ 1 + remstats::send("z", covar) + # Exogenous statistics
  ...
  remstats::osp(scaling='std') # Endogenous statistics
...
windows <- REHdynamics::createwindows(1400, tau)
...
```{r}
# extract the parameters
fixmw_osp_1cp_param <- 1
for (i in 1:length(model_fixwin_1cp)) {
  fixmw_osp_1cp_param[i] <- model_fixwin_1cp[[i]][["coefficients"]][["osp"]]
}
plot(fixmw_osp_1cp_param, type = "lm") # plot the movement of parameter
```
...
```{r}
BOCD_fixmw_osp_1cp_param <- onlineCPD(fixmw_osp_1cp_param, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_fixmw_osp_1cp_param[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_fixmw_osp_1cp_param)
```
...
```{r}
PELT_fixmw_osp_1cp_param <- cpt.meanvar(fixmw_osp_1cp_param, method="PELT")
summary(PELT_fixmw_osp_1cp_param)

# plot the location of CPs
plot(fixmw_osp_1cp_param, type="l", col = "red")
abline(v=PELT_fixmw_osp_1cp_param@cpts[], col="black")
```
...
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_fixmw_osp_1cp_param <- cpt.meanvar(fixmw_osp_1cp_param, method = "BinSeg")
cpts(BS_fixmw_osp_1cp_param)

# plot the location of CPs
plot(fixmw_osp_1cp_param)
abline(v=BS_fixmw_osp_1cp_param@cpts[], col="red")
```
...
# specify the length of the window
windows_1cp_same.all <- REHdynamics::createwindows(1200, tau)
...
```{r}
# extract the parameters
fixmw_osp_1cp_param_same.all <- 1
for (i in 1:length(model_fixwin_1cp_same.all)) {
  fixmw_osp_1cp_param_same.all[i] <- model_fixwin_1cp_same.all[[i]][["coefficients"]][["osp"]]
}
plot(fixmw_osp_1cp_param_same.all, type = "lm") # plot the movement of parameter
```
...
```{r}
BOCD_fixmw_osp_1cp_param_same.all <- onlineCPD(fixmw_osp_1cp_param_same.all, 
                                               getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_fixmw_osp_1cp_param_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_fixmw_osp_1cp_param_same.all)
```
...
```{r}
PELT_fixmw_osp_1cp_param_same.all <- cpt.var(fixmw_osp_1cp_param_same.all, method="PELT")
summary(PELT_fixmw_osp_1cp_param_same.all)

# plot the location of CPs
plot(fixmw_osp_1cp_param_same.all, type="l", col = "red")
abline(v=PELT_fixmw_osp_1cp_param_same.all@cpts[], col="black")
```
...
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_fixmw_reci_1cp_param_same.all <- cpt.meanvar(fixmw_reci_1cp_param_same.all, method = "BinSeg")
cpts(BS_fixmw_reci_1cp_param_same.all)

# plot the location of CPs
plot(fixmw_reci_1cp_param_same.all)
abline(v=BS_fixmw_reci_1cp_param_same.all@cpts[], col="red")
```
...
# fit to the REM model
model_fixwin_1cp_diff.all <- REHdynamics::MWrem(windows, edgelist = reh_1cp_diff.all, 
...
```{r}
# extract the parameters
fixmw_osp_1cp_param_diff.all <- 1
for (i in 1:length(model_fixwin_1cp_diff.all)) {
  fixmw_osp_1cp_param_diff.all[i] <- model_fixwin_1cp_diff.all[[i]][["coefficients"]][["osp"]]
}
plot(fixmw_osp_1cp_param_diff.all, type = "lm") # plot the movement of parameter
```
...
```{r}
BOCD_fixmw_osp_1cp_param_diff.all <- onlineCPD(fixmw_osp_1cp_param_diff.all, 
                                               getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_fixmw_osp_1cp_param_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_fixmw_osp_1cp_param_diff.all)
```
...
```{r}
PELT_fixmw_osp_1cp_param_diff.all <- cpt.var(fixmw_osp_1cp_param_diff.all, method="PELT")
summary(PELT_fixmw_osp_1cp_param_diff.all)

# plot the location of CPs
plot(fixmw_osp_1cp_param_diff.all, type="l", col = "red")
abline(v=PELT_fixmw_osp_1cp_param_diff.all@cpts[], col="black")
```
...
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_fixmw_osp_1cp_param_diff.all <- cpt.meanvar(fixmw_osp_1cp_param_diff.all, method = "BinSeg")
cpts(BS_fixmw_osp_1cp_param_diff.all)

# plot the location of CPs
plot(fixmw_osp_1cp_param_diff.all)
abline(v=BS_fixmw_osp_1cp_param_diff.all@cpts[], col="red")
```
...
```{r}
WBS_fixmw_osp_1cp_param_diff.all <- wbs(fixmw_osp_1cp_param_diff.all)
changepoints(WBS_fixmw_osp_1cp_param_diff.all)
plot(WBS_fixmw_osp_1cp_param_diff.all)
```
...
# fit to the REM model
model_fixwin_2cp <- REHdynamics::MWrem(windows, edgelist = reh_2cp, 
                                       stats = stat.2cp,
                                       actors = covar$id, directed = TRUE, 
                                       method = "MLE", model = "tie", ncores = 2)
```
...
2. PELT: Exact CPs Detection Method
```{r}
PELT_fixmw_ine_2cp_param <- cpt.var(fixmw_ine_2cp_param, method="PELT")
