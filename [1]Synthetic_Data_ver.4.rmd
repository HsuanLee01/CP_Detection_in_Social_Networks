...
```{r}
# extract the statistics of send
send_3cp_same.all <- stat.3cp_same.all[,,2]

# aggregate the statistics of each time point
send_3cp.agg.max_same.all <- rowMaxs(send_3cp_same.all)
plot(send_3cp.agg.max_same.all, type = "lm")

send_3cp.agg.mean_same.all <- rowMeans(send_3cp_same.all)
plot(send_3cp.agg.mean_same.all, type = "lm")
```

```{r}
# extract the statistics of diff
diff_3cp_same.all <- stat.3cp_same.all[,,3]

# aggregate the statistics of each time point
diff_3cp.agg.max_same.all <- rowMaxs(diff_3cp_same.all)
plot(diff_3cp.agg.max_same.all, type = "lm")

diff_3cp.agg.mean_same.all <- rowMeans(diff_3cp_same.all)
plot(diff_3cp.agg.mean_same.all, type = "lm")
```

```{r}
# extract the statistics of inertia
ine_3cp_same.all <- stat.3cp_same.all[,,4]

# aggregate the statistics of each time point
ine_3cp.agg.max_same.all <- rowMaxs(ine_3cp_same.all)
plot(ine_3cp.agg.max_same.all, type = "lm")

ine_3cp.agg.mean_same.all <- rowMeans(ine_3cp_same.all)
plot(ine_3cp.agg.mean_same.all, type = "lm")
```

```{r}
# extract the statistics of diff
reci_3cp_same.all <- stat.3cp_same.all[,,5]

# aggregate the statistics of each time point
reci_3cp.agg.max_same.all <- rowMaxs(reci_3cp_same.all)
plot(reci_3cp.agg.max_same.all, type = "lm")

reci_3cp.agg.mean_same.all <- rowMeans(reci_3cp_same.all)
plot(reci_3cp.agg.mean_same.all, type = "lm")
```
...
1. BOCD: Exact CPs Detection Method
```{r}
BOCD_send_3cp.agg.mean_same.all <- onlineCPD(send_3cp.agg.mean_same.all, 
                                            getR = T, optionalOutputs = T, 
                                            truncRlim = 10^-4)
BOCD_send_3cp.agg.mean_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_send_3cp.agg.mean_same.all)

BOCD_send_3cp.agg.max_same.all <- onlineCPD(send_3cp.agg.max_same.all, getR = T, 
                                           optionalOutputs = T, truncRlim = 10^-4)
BOCD_send_3cp.agg.max_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_send_3cp.agg.max_same.all)
```

```{r}
BOCD_diff_3cp.agg.mean_same.all <- onlineCPD(diff_3cp.agg.mean_same.all, 
                                            getR = T, optionalOutputs = T, 
                                            truncRlim = 10^-4)
BOCD_diff_3cp.agg.mean_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_diff_3cp.agg.mean_same.all)

BOCD_diff_3cp.agg.max_same.all <- onlineCPD(diff_3cp.agg.max_same.all, getR = T, 
                                           optionalOutputs = T, truncRlim = 10^-4)
BOCD_diff_3cp.agg.max_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_diff_3cp.agg.max_same.all)
```

```{r}
BOCD_ine_3cp.agg.mean_same.all <- onlineCPD(ine_3cp.agg.mean_same.all, 
                                            getR = T, optionalOutputs = T, 
                                            truncRlim = 10^-4)
BOCD_ine_3cp.agg.mean_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_ine_3cp.agg.mean_same.all)

BOCD_ine_3cp.agg.max_same.all <- onlineCPD(ine_3cp.agg.max_same.all, getR = T, 
                                           optionalOutputs = T, truncRlim = 10^-4)
BOCD_ine_3cp.agg.max_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_ine_3cp.agg.max_same.all)
```

```{r}
BOCD_reci_3cp.agg.mean_same.all <- onlineCPD(reci_3cp.agg.mean_same.all, 
                                            getR = T, optionalOutputs = T, 
                                            truncRlim = 10^-4)
BOCD_reci_3cp.agg.mean_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_reci_3cp.agg.mean_same.all)

BOCD_reci_3cp.agg.max_same.all <- onlineCPD(reci_3cp.agg.max_same.all, getR = T, 
                                           optionalOutputs = T, truncRlim = 10^-4)
BOCD_reci_3cp.agg.max_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_reci_3cp.agg.max_same.all)
```
...
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_send_3cp.agg.mean_same.all <- cpt.var(send_3cp.agg.mean_same.all, method="PELT")
summary(PELT_send_3cp.agg.mean_same.all)

# plot the location of detected CPs
plot(send_3cp.agg.mean_same.all, type="point", col = "black")
abline(v=PELT_send_3cp.agg.mean_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_diff_3cp.agg.mean_same.all <- cpt.var(diff_3cp.agg.mean_same.all, method="PELT")
summary(PELT_diff_3cp.agg.mean_same.all)

# plot the location of detected CPs
plot(diff_3cp.agg.mean_same.all, type="point", col = "black")
abline(v=PELT_diff_3cp.agg.mean_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_ine_3cp.agg.mean_same.all <- cpt.var(ine_3cp.agg.mean_same.all, method="PELT")
summary(PELT_ine_3cp.agg.mean_same.all)

# plot the location of detected CPs
plot(ine_3cp.agg.mean_same.all, type="point", col = "black")
abline(v=PELT_ine_3cp.agg.mean_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_reci_3cp.agg.mean_same.all <- cpt.var(reci_3cp.agg.mean_same.all, method="PELT")
summary(PELT_reci_3cp.agg.mean_same.all)

# plot the location of detected CPs
plot(reci_3cp.agg.mean_same.all, type="point", col = "black")
abline(v=PELT_reci_3cp.agg.mean_same.all@cpts[], col="red")
```

- Max
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_send_3cp.agg.max_same.all <- cpt.var(send_3cp.agg.max_same.all, method="PELT")
summary(PELT_send_3cp.agg.max_same.all)

# plot the location of detected CPs
plot(send_3cp.agg.max_same.all, type="point", col = "black")
abline(v=PELT_send_3cp.agg.max_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_diff_3cp.agg.max_same.all <- cpt.var(diff_3cp.agg.max_same.all, method="PELT")
summary(PELT_diff_3cp.agg.max_same.all)

# plot the location of detected CPs
plot(diff_3cp.agg.max_same.all, type="point", col = "black")
abline(v=PELT_diff_3cp.agg.max_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_ine_3cp.agg.max_same.all <- cpt.var(ine_3cp.agg.max_same.all, method="PELT")
summary(PELT_ine_3cp.agg.max_same.all)

# plot the location of detected CPs
plot(ine_3cp.agg.max_same.all, type="point", col = "black")
abline(v=PELT_ine_3cp.agg.max_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_reci_3cp.agg.max_same.all <- cpt.var(reci_3cp.agg.max_same.all, method="PELT")
summary(PELT_reci_3cp.agg.max_same.all)

# plot the location of detected CPs
plot(reci_3cp.agg.max_same.all, type="point", col = "black")
abline(v=PELT_reci_3cp.agg.max_same.all@cpts[], col="red")
```
...
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_send_3cp.agg.mean_same.all <- cpt.var(send_3cp.agg.mean_same.all, method = "BinSeg")
cpts(BS_send_3cp.agg.mean_same.all)

# plot the location of CPs
plot(send_3cp.agg.mean_same.all)
abline(v=BS_send_3cp.agg.mean_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_diff_3cp.agg.mean_same.all <- cpt.var(diff_3cp.agg.mean_same.all, method = "BinSeg")
cpts(BS_diff_3cp.agg.mean_same.all)

# plot the location of CPs
plot(diff_3cp.agg.mean_same.all)
abline(v=BS_diff_3cp.agg.mean_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_ine_3cp.agg.mean_same.all <- cpt.var(ine_3cp.agg.mean_same.all, method = "BinSeg")
cpts(BS_ine_3cp.agg.mean_same.all)

# plot the location of CPs
plot(ine_3cp.agg.mean_same.all)
abline(v=BS_ine_3cp.agg.mean_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_reci_3cp.agg.mean_same.all <- cpt.var(reci_3cp.agg.mean_same.all, method = "BinSeg")
cpts(BS_reci_3cp.agg.mean_same.all)

# plot the location of CPs
plot(reci_3cp.agg.mean_same.all)
ablreci(v=BS_reci_3cp.agg.mean_same.all@cpts[], col="red")
```

- Max
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_send_3cp.agg.max_same.all <- cpt.var(send_3cp.agg.max_same.all, method = "BinSeg")
cpts(BS_send_3cp.agg.max_same.all)

# plot the location of CPs
plot(send_3cp.agg.max_same.all)
abline(v=BS_send_3cp.agg.max_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_diff_3cp.agg.max_same.all <- cpt.var(diff_3cp.agg.max_same.all, method = "BinSeg")
cpts(BS_diff_3cp.agg.max_same.all)

# plot the location of CPs
plot(diff_3cp.agg.max_same.all)
abline(v=BS_diff_3cp.agg.max_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_ine_3cp.agg.max_same.all <- cpt.var(ine_3cp.agg.max_same.all, method = "BinSeg")
cpts(BS_ine_3cp.agg.max_same.all)

# plot the location of CPs
plot(ine_3cp.agg.max_same.all)
abline(v=BS_ine_3cp.agg.max_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_reci_3cp.agg.max_same.all <- cpt.var(reci_3cp.agg.max_same.all, method = "BinSeg")
cpts(BS_reci_3cp.agg.max_same.all)

# plot the location of CPs
plot(reci_3cp.agg.max_same.all)
abline(v=BS_diff_3cp.agg.max_same.all@cpts[], col="red")
```
...
- Mean
```{r}
WBS_send_3cp.agg.mean_same.all <- wbs(send_3cp.agg.mean_same.all)
changepoints(WBS_send_3cp.agg.mean_same.all)
plot(WBS_send_3cp.agg.mean_same.all)
```

```{r}
WBS_diff_3cp.agg.mean_same.all <- wbs(diff_3cp.agg.mean_same.all)
changepoints(WBS_diff_3cp.agg.mean_same.all)
plot(WBS_diff_3cp.agg.mean_same.all)
```

```{r}
WBS_ine_3cp.agg.mean_same.all <- wbs(ine_3cp.agg.mean_same.all)
changepoints(WBS_ine_3cp.agg.mean_same.all)
plot(WBS_ine_3cp.agg.mean_same.all)
```

```{r}
WBS_reci_3cp.agg.mean_same.all <- wbs(reci_3cp.agg.mean_same.all)
changepoints(WBS_reci_3cp.agg.mean_same.all)
plot(WBS_reci_3cp.agg.mean_same.all)
```

- Max
```{r}
WBS_send_3cp.agg.max_same.all <- wbs(send_3cp.agg.max_same.all)
changepoints(WBS_send_3cp.agg.max_same.all)
plot(WBS_send_3cp.agg.max_same.all)
```

```{r}
WBS_diff_3cp.agg.max_same.all <- wbs(diff_3cp.agg.max_same.all)
changepoints(WBS_diff_3cp.agg.max_same.all)
plot(WBS_diff_3cp.agg.max_same.all)
```

```{r}
WBS_ine_3cp.agg.max_same.all <- wbs(ine_3cp.agg.max_same.all)
changepoints(WBS_ine_3cp.agg.max_same.all)
plot(WBS_ine_3cp.agg.max_same.all)
```

```{r}
WBS_reci_3cp.agg.max_same.all <- wbs(reci_3cp.agg.max_same.all)
changepoints(WBS_reci_3cp.agg.max_same.all)
plot(WBS_reci_3cp.agg.max_same.all)
```
...
```{r}
# compute the mean of top 5% of maximum statistics by timepoints
top_send_3cp_same.all <- max_mean_time(send_3cp_same.all, percent = 0.05)$means_max.values_each_timepoint
plot(top_send_3cp_same.all) # plot it out
```

```{r}
# compute the mean of top 5% of maximum statistics by timepoints
top_diff_3cp_same.all <- max_mean_time(diff_3cp_same.all, percent = 0.05)$means_max.values_each_timepoint
plot(top_diff_3cp_same.all) # plot it out
```

```{r}
# compute the mean of top 5% of maximum statistics by timepoints
top_ine_3cp_same.all <- max_mean_time(ine_3cp_same.all, percent = 0.05)$means_max.values_each_timepoint
plot(top_ine_3cp_same.all) # plot it out
```

```{r}
# compute the mean of top 5% of maximum statistics by timepoints
top_reci_3cp_same.all <- max_mean_time(reci_3cp_same.all, percent = 0.05)$means_max.values_each_timepoint
plot(top_reci_3cp_same.all) # plot it out
```

1. BOCD: Exact CPs Detection Method
```{r}
# test the CPs
BOCD_send_3cp.agg.top_same.all <- onlineCPD(top_send_3cp_same.all, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_send_3cp.agg.top_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_send_3cp.agg.top_same.all)
```

```{r}
# test the CPs
BOCD_diff_3cp.agg.top_same.all <- onlineCPD(top_diff_3cp_same.all, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_diff_3cp.agg.top_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_diff_3cp.agg.top_same.all)
```

```{r}
# test the CPs
BOCD_ine_3cp.agg.top_same.all <- onlineCPD(top_ine_3cp_same.all, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_ine_3cp.agg.top_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_ine_3cp.agg.top_same.all)
```

```{r}
# test the CPs
BOCD_reci_3cp.agg.top_same.all <- onlineCPD(top_reci_3cp_same.all, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_reci_3cp.agg.top_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_reci_3cp.agg.top_same.all)
```

2. PELT: Exact CPs Detection Method
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_send_3cp.agg.top_same.all <- cpt.var(top_send_3cp_same.all, method="PELT")
summary(PELT_send_3cp.agg.top_same.all)

# plot the location of detected CPs
plot(top_send_3cp_same.all, type="point", col = "black")
abline(v=PELT_ine_3cp.agg.top_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_diff_3cp.agg.top_same.all <- cpt.var(top_diff_3cp_same.all, method="PELT")
summary(PELT_diff_3cp.agg.top_same.all)

# plot the location of detected CPs
plot(top_diff_3cp_same.all, type="point", col = "black")
abline(v=PELT_diff_3cp.agg.top_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_ine_3cp.agg.top_same.all <- cpt.var(top_ine_3cp_same.all, method="PELT")
summary(PELT_ine_3cp.agg.top_same.all)

# plot the location of detected CPs
plot(top_ine_3cp_same.all, type="point", col = "black")
abline(v=PELT_ine_3cp.agg.top_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_reci_3cp.agg.top_same.all <- cpt.var(top_reci_3cp_same.all, method="PELT")
summary(PELT_reci_3cp.agg.top_same.all)

# plot the location of detected CPs
plot(top_reci_3cp_same.all, type="point", col = "black")
abline(v=PELT_reci_3cp.agg.top_same.all@cpts[], col="red")
```

3. BS: approximate CPs Detection Method
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_send_3cp.agg.top_same.all <- cpt.meanvar(top_send_3cp_same.all, method = "BinSeg")
cpts(BS_send_3cp.agg.top_same.all)

# plot the location of CPs
plot(top_send_3cp_same.all)
abline(v=BS_send_3cp.agg.top_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_diff_3cp.agg.top_same.all <- cpt.meanvar(top_diff_3cp_same.all, method = "BinSeg")
cpts(BS_diff_3cp.agg.top_same.all)

# plot the location of CPs
plot(top_diff_3cp_same.all)
abline(v=BS_diff_3cp.agg.top_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_ine_3cp.agg.top_same.all <- cpt.meanvar(top_ine_3cp_same.all, method = "BinSeg")
cpts(BS_ine_3cp.agg.top_same.all)

# plot the location of CPs
plot(top_ine_3cp_same.all)
abline(v=BS_ine_3cp.agg.top_same.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_reci_3cp.agg.top_same.all <- cpt.meanvar(top_reci_3cp_same.all, method = "BinSeg")
cpts(BS_reci_3cp.agg.top_same.all)

# plot the location of CPs
plot(top_reci_3cp_same.all)
abline(v=BS_reci_3cp.agg.top_same.all@cpts[], col="red")
```

4. Wild BS
```{r}
WBS_send_3cp.agg.top <- wbs(top_send_3cp_same.all)
changepoints(WBS_send_3cp.agg.top_same.all)
plot(WBS_send_3cp.agg.top_same.all)
```

```{r}
WBS_diff_3cp.agg.top <- wbs(top_diff_3cp_same.all)
changepoints(WBS_diff_3cp.agg.top_same.all)
plot(WBS_diff_3cp.agg.top_same.all)
```

```{r}
WBS_ine_3cp.agg.top <- wbs(top_ine_3cp_same.all)
changepoints(WBS_ine_3cp.agg.top_same.all)
plot(WBS_ine_3cp.agg.top_same.all)
```

```{r}
WBS_reci_3cp.agg.top <- wbs(top_reci_3cp_same.all)
changepoints(WBS_reci_3cp.agg.top_same.all)
plot(WBS_reci_3cp.agg.top_same.all)
```
...
```{r}
# obtain data-driven window widths
ddwin_3cp_same.all <- ddwindows(edgelist = reh_3cp_same.all, tie_effects = formula, mintime = 2000, 
		covar = covar)
```
...
```{r}
#  fits a moving window relational event model
model_ddwin_3cp_same.all <- MWrem(windows = ddwin_3cp_same.all$windows, edgelist = reh_3cp_same.all, 
		stats = stat.3cp_same.all, actors = covar$id, directed = TRUE)
```

3. Step 3: extract the parameters by windows and plot them out
```{r}
# extract the parameters
ddmw_send_3cp_param_same.all <- 1
for (i in 1:length(model_ddwin_3cp_same.all)) {
  ddmw_send_3cp_param_same.all[i] <- model_ddwin_3cp_same.all[[i]][["coefficients"]][["send.z"]]
}
plot(ddmw_send_3cp_param_same.all, type = "lm") # plot the movement of parameter
```

```{r}
# extract the parameters
ddmw_diff_3cp_param_same.all <- 1
for (i in 1:length(model_ddwin_3cp_same.all)) {
  ddmw_diff_3cp_param_same.all[i] <- model_ddwin_3cp_same.all[[i]][["coefficients"]][["difference.z"]]
}
plot(ddmw_diff_3cp_param_same.all, type = "lm") # plot the movement of parameter
```

```{r}
# extract the parameters
ddmw_ine_3cp_param_same.all <- 1
for (i in 1:length(model_ddwin_3cp_same.all)) {
  ddmw_ine_3cp_param_same.all[i] <- model_ddwin_3cp_same.all[[i]][["coefficients"]][["inertia"]]
}
plot(ddmw_ine_3cp_param_same.all, type = "lm") # plot the movement of parameter
```

```{r}
# extract the parameters
ddmw_reci_3cp_param_same.all <- 1
for (i in 1:length(model_ddwin_3cp_same.all)) {
  ddmw_reci_3cp_param_same.all[i] <- model_ddwin_3cp_same.all[[i]][["coefficients"]][["reciprocity"]]
}
plot(ddmw_reci_3cp_param_same.all, type = "lm") # plot the movement of parameter
```
...
1. BOCD: Exact CPs Detection Method
```{r}
BOCD_ddmw_send_3cp_param_same.all <- onlineCPD(ddmw_send_3cp_param_same.all, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_ddmw_send_3cp_param_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_ddmw_send_3cp_param_same.all)
```

```{r}
BOCD_ddmw_diff_3cp_param_same.all <- onlineCPD(ddmw_diff_3cp_param_same.all, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_ddmw_diff_3cp_param_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_ddmw_diff_3cp_param_same.all)
```

```{r}
BOCD_ddmw_ine_3cp_param_same.all <- onlineCPD(ddmw_ine_3cp_param_same.all, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_ddmw_ine_3cp_param_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_ddmw_ine_3cp_param_same.all)
```

```{r}
BOCD_ddmw_reci_3cp_param_same.all <- onlineCPD(ddmw_reci_3cp_param_same.all, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_ddmw_reci_3cp_param_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_ddmw_reci_3cp_param_same.all)
```

2. PELT: Exact CPs Detection Method
```{r}
PELT_ddmw_send_3cp_param_same.all <- cpt.var(ddmw_send_3cp_param_same.all, method="PELT")
summary(PELT_ddmw_send_3cp_param_same.all)

# plot the location of CPs
plot(ddmw_send_3cp_param_same.all, type="l", col = "red")
abline(v=PELT_ddmw_send_3cp_param_same.all@cpts[], col="black")
```

```{r}
PELT_ddmw_diff_3cp_param_same.all <- cpt.var(ddmw_diff_3cp_param_same.all, method="PELT")
summary(PELT_ddmw_diff_3cp_param_same.all)

# plot the location of CPs
plot(ddmw_diff_3cp_param_same.all, type="l", col = "red")
abline(v=PELT_ddmw_diff_3cp_param_same.all@cpts[], col="black")
```

```{r}
PELT_ddmw_ine_3cp_param_same.all <- cpt.var(ddmw_ine_3cp_param_same.all, method="PELT")
summary(PELT_ddmw_ine_3cp_param_same.all)

# plot the location of CPs
plot(ddmw_ine_3cp_param_same.all, type="l", col = "red")
abline(v=PELT_ddmw_ine_3cp_param_same.all@cpts[], col="black")
```

```{r}
PELT_ddmw_reci_3cp_param_same.all <- cpt.var(ddmw_reci_3cp_param_same.all, method="PELT")
summary(PELT_ddmw_reci_3cp_param_same.all)

# plot the location of CPs
plot(ddmw_reci_3cp_param_same.all, type="l", col = "red")
abline(v=PELT_ddmw_reci_3cp_param_same.all@cpts[], col="black")
```

3. BS: approximate CPs Detection Method
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_ddmw_send_3cp_param_same.all <- cpt.var(ddmw_send_3cp_param_same.all, method = "BinSeg")
cpts(BS_ddmw_send_3cp_param_same.all)

# plot the location of CPs
plot(ddmw_send_3cp_param_same.all)
abline(v=BS_ddmw_send_3cp_param_same.all@cpts[], col="black")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_ddmw_diff_3cp_param_same.all <- cpt.var(ddmw_diff_3cp_param_same.all, method = "BinSeg")
cpts(BS_ddmw_diff_3cp_param_same.all)

# plot the location of CPs
plot(ddmw_diff_3cp_param_same.all)
abline(v=BS_ddmw_diff_3cp_param_same.all@cpts[], col="black")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_ddmw_ine_3cp_param_same.all <- cpt.var(ddmw_ine_3cp_param_same.all, method = "BinSeg")
cpts(BS_ddmw_ine_3cp_param_same.all)

# plot the location of CPs
plot(ddmw_ine_3cp_param_same.all)
abline(v=BS_ddmw_ine_3cp_param_same.all@cpts[], col="black")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_ddmw_reci_3cp_param_same.all <- cpt.var(ddmw_reci_3cp_param_same.all, method = "BinSeg")
cpts(BS_ddmw_reci_3cp_param_same.all)

# plot the location of CPs
plot(ddmw_reci_3cp_param_same.all)
abline(v=BS_ddmw_reci_3cp_param_same.all@cpts[], col="black")
```

4. Wild BS
```{r}
WBS_ddmw_send_3cp_param_same.all <- wbs(ddmw_send_3cp_param_same.all)
changepoints(WBS_ddmw_send_3cp_param_same.all)
plot(WBS_ddmw_send_3cp_param_same.all)
```

```{r}
WBS_ddmw_diff_3cp_param_same.all <- wbs(ddmw_diff_3cp_param_same.all)
changepoints(WBS_ddmw_diff_3cp_param_same.all)
plot(WBS_ddmw_diff_3cp_param_same.all)
```

```{r}
WBS_ddmw_ine_3cp_param_same.all <- wbs(ddmw_ine_3cp_param_same.all)
changepoints(WBS_ddmw_ine_3cp_param_same.all)
plot(WBS_ddmw_ine_3cp_param_same.all)
```

```{r}
WBS_ddmw_reci_3cp_param_same.all <- wbs(ddmw_reci_3cp_param_same.all)
changepoints(WBS_ddmw_reci_3cp_param_same.all)
plot(WBS_ddmw_reci_3cp_param_same.all)
```
...
4. Wild BS
```{r}
WBS_fixmw_send_3cp_param_same.all <- wbs(fixmw_send_3cp_param_same.all)
changepoints(WBS_fixmw_send_3cp_param_same.all)
plot(WBS_fixmw_send_3cp_param_same.all)
```

```{r}
WBS_fixmw_diff_3cp_param_same.all <- wbs(fixmw_diff_3cp_param_same.all)
changepoints(WBS_fixmw_diff_3cp_param_same.all)
plot(WBS_fixmw_diff_3cp_param_same.all)
```

```{r}
WBS_fixmw_ine_3cp_param_same.all <- wbs(fixmw_ine_3cp_param_same.all)
changepoints(WBS_fixmw_ine_3cp_param_same.all)
plot(WBS_fixmw_ine_3cp_param_same.all)
```

```{r}
WBS_fixmw_reci_3cp_param_same.all <- wbs(fixmw_reci_3cp_param_same.all)
changepoints(WBS_fixmw_reci_3cp_param_same.all)
plot(WBS_fixmw_reci_3cp_param_same.all)
```
...
```{r}
# extract the statistics of send
send_3cp_diff.all <- stat.3cp_diff.all[,,2]

# aggregate the statistics of each time point
send_3cp.agg.max_diff.all <- rowMaxs(send_3cp_diff.all)
plot(send_3cp.agg.max_diff.all, type = "lm")

send_3cp.agg.mean_diff.all <- rowMeans(send_3cp_diff.all)
plot(send_3cp.agg.mean_diff.all, type = "lm")
```

```{r}
# extract the statistics of diff
diff_3cp_diff.all <- stat.3cp_diff.all[,,3]

# aggregate the statistics of each time point
diff_3cp.agg.max_diff.all <- rowMaxs(diff_3cp_diff.all)
plot(diff_3cp.agg.max_diff.all, type = "lm")

diff_3cp.agg.mean_diff.all <- rowMeans(diff_3cp_diff.all)
plot(diff_3cp.agg.mean_diff.all, type = "lm")
```

```{r}
# extract the statistics of inertia
ine_3cp_diff.all <- stat.3cp_diff.all[,,4]

# aggregate the statistics of each time point
ine_3cp.agg.max_diff.all <- rowMaxs(ine_3cp_diff.all)
plot(ine_3cp.agg.max_diff.all, type = "lm")

ine_3cp.agg.mean_diff.all <- rowMeans(ine_3cp_diff.all)
plot(ine_3cp.agg.mean_diff.all, type = "lm")
```

```{r}
# extract the statistics of diff
reci_3cp_diff.all <- stat.3cp_diff.all[,,5]

# aggregate the statistics of each time point
reci_3cp.agg.max_diff.all <- rowMaxs(reci_3cp_diff.all)
plot(reci_3cp.agg.max_diff.all, type = "lm")

reci_3cp.agg.mean_diff.all <- rowMeans(reci_3cp_diff.all)
plot(reci_3cp.agg.mean_diff.all, type = "lm")
```
...
1. BOCD: Exact CPs Detection Method
```{r}
BOCD_send_3cp.agg.mean_diff.all <- onlineCPD(send_3cp.agg.mean_diff.all, 
                                            getR = T, optionalOutputs = T, 
                                            truncRlim = 10^-4)
BOCD_send_3cp.agg.mean_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_send_3cp.agg.mean_diff.all)

BOCD_send_3cp.agg.max_diff.all <- onlineCPD(send_3cp.agg.max_diff.all, getR = T, 
                                           optionalOutputs = T, truncRlim = 10^-4)
BOCD_send_3cp.agg.max_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_send_3cp.agg.max_diff.all)
```

```{r}
BOCD_diff_3cp.agg.mean_diff.all <- onlineCPD(diff_3cp.agg.mean_diff.all, 
                                            getR = T, optionalOutputs = T, 
                                            truncRlim = 10^-4)
BOCD_diff_3cp.agg.mean_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_diff_3cp.agg.mean_diff.all)

BOCD_diff_3cp.agg.max_diff.all <- onlineCPD(diff_3cp.agg.max_diff.all, getR = T, 
                                           optionalOutputs = T, truncRlim = 10^-4)
BOCD_diff_3cp.agg.max_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_diff_3cp.agg.max_diff.all)
```

```{r}
BOCD_ine_3cp.agg.mean_diff.all <- onlineCPD(ine_3cp.agg.mean_diff.all, 
                                            getR = T, optionalOutputs = T, 
                                            truncRlim = 10^-4)
BOCD_ine_3cp.agg.mean_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_ine_3cp.agg.mean_diff.all)

BOCD_ine_3cp.agg.max_diff.all <- onlineCPD(ine_3cp.agg.max_diff.all, getR = T, 
                                           optionalOutputs = T, truncRlim = 10^-4)
BOCD_ine_3cp.agg.max_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_ine_3cp.agg.max_diff.all)
```

```{r}
BOCD_reci_3cp.agg.mean_diff.all <- onlineCPD(reci_3cp.agg.mean_diff.all, 
                                            getR = T, optionalOutputs = T, 
                                            truncRlim = 10^-4)
BOCD_reci_3cp.agg.mean_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_reci_3cp.agg.mean_diff.all)

BOCD_reci_3cp.agg.max_diff.all <- onlineCPD(reci_3cp.agg.max_diff.all, getR = T, 
                                           optionalOutputs = T, truncRlim = 10^-4)
BOCD_reci_3cp.agg.max_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_reci_3cp.agg.max_diff.all)
```
...
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_send_3cp.agg.mean_diff.all <- cpt.var(send_3cp.agg.mean_diff.all, method="PELT")
summary(PELT_send_3cp.agg.mean_diff.all)

# plot the location of detected CPs
plot(send_3cp.agg.mean_diff.all, type="point", col = "black")
abline(v=PELT_send_3cp.agg.mean_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_diff_3cp.agg.mean_diff.all <- cpt.var(diff_3cp.agg.mean_diff.all, method="PELT")
summary(PELT_diff_3cp.agg.mean_diff.all)

# plot the location of detected CPs
plot(diff_3cp.agg.mean_diff.all, type="point", col = "black")
abline(v=PELT_diff_3cp.agg.mean_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_ine_3cp.agg.mean_diff.all <- cpt.var(ine_3cp.agg.mean_diff.all, method="PELT")
summary(PELT_ine_3cp.agg.mean_diff.all)

# plot the location of detected CPs
plot(ine_3cp.agg.mean_diff.all, type="point", col = "black")
abline(v=PELT_ine_3cp.agg.mean_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_reci_3cp.agg.mean_diff.all <- cpt.var(reci_3cp.agg.mean_diff.all, method="PELT")
summary(PELT_reci_3cp.agg.mean_diff.all)

# plot the location of detected CPs
plot(reci_3cp.agg.mean_diff.all, type="point", col = "black")
abline(v=PELT_reci_3cp.agg.mean_diff.all@cpts[], col="red")
```

- Max
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_send_3cp.agg.max_diff.all <- cpt.var(send_3cp.agg.max_diff.all, method="PELT")
summary(PELT_send_3cp.agg.max_diff.all)

# plot the location of detected CPs
plot(send_3cp.agg.max_diff.all, type="point", col = "black")
abline(v=PELT_send_3cp.agg.max_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_diff_3cp.agg.max_diff.all <- cpt.var(diff_3cp.agg.max_diff.all, method="PELT")
summary(PELT_diff_3cp.agg.max_diff.all)

# plot the location of detected CPs
plot(diff_3cp.agg.max_diff.all, type="point", col = "black")
abline(v=PELT_diff_3cp.agg.max_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_ine_3cp.agg.max_diff.all <- cpt.var(ine_3cp.agg.max_diff.all, method="PELT")
summary(PELT_ine_3cp.agg.max_diff.all)

# plot the location of detected CPs
plot(ine_3cp.agg.max_diff.all, type="point", col = "black")
abline(v=PELT_ine_3cp.agg.max_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_reci_3cp.agg.max_diff.all <- cpt.var(reci_3cp.agg.max_diff.all, method="PELT")
summary(PELT_reci_3cp.agg.max_diff.all)

# plot the location of detected CPs
plot(reci_3cp.agg.max_diff.all, type="point", col = "black")
abline(v=PELT_reci_3cp.agg.max_diff.all@cpts[], col="red")
```
...
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_send_3cp.agg.mean_diff.all <- cpt.var(send_3cp.agg.mean_diff.all, method = "BinSeg")
cpts(BS_send_3cp.agg.mean_diff.all)

# plot the location of CPs
plot(send_3cp.agg.mean_diff.all)
abline(v=BS_send_3cp.agg.mean_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_diff_3cp.agg.mean_diff.all <- cpt.var(diff_3cp.agg.mean_diff.all, method = "BinSeg")
cpts(BS_diff_3cp.agg.mean_diff.all)

# plot the location of CPs
plot(diff_3cp.agg.mean_diff.all)
abline(v=BS_diff_3cp.agg.mean_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_ine_3cp.agg.mean_diff.all <- cpt.var(ine_3cp.agg.mean_diff.all, method = "BinSeg")
cpts(BS_ine_3cp.agg.mean_diff.all)

# plot the location of CPs
plot(ine_3cp.agg.mean_diff.all)
abline(v=BS_ine_3cp.agg.mean_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_reci_3cp.agg.mean_diff.all <- cpt.var(reci_3cp.agg.mean_diff.all, method = "BinSeg")
cpts(BS_reci_3cp.agg.mean_diff.all)

# plot the location of CPs
plot(reci_3cp.agg.mean_diff.all)
ablreci(v=BS_reci_3cp.agg.mean_diff.all@cpts[], col="red")
```

- Max
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_send_3cp.agg.max_diff.all <- cpt.var(send_3cp.agg.max_diff.all, method = "BinSeg")
cpts(BS_send_3cp.agg.max_diff.all)

# plot the location of CPs
plot(send_3cp.agg.max_diff.all)
abline(v=BS_send_3cp.agg.max_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_diff_3cp.agg.max_diff.all <- cpt.var(diff_3cp.agg.max_diff.all, method = "BinSeg")
cpts(BS_diff_3cp.agg.max_diff.all)

# plot the location of CPs
plot(diff_3cp.agg.max_diff.all)
abline(v=BS_diff_3cp.agg.max_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_ine_3cp.agg.max_diff.all <- cpt.var(ine_3cp.agg.max_diff.all, method = "BinSeg")
cpts(BS_ine_3cp.agg.max_diff.all)

# plot the location of CPs
plot(ine_3cp.agg.max_diff.all)
abline(v=BS_ine_3cp.agg.max_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_reci_3cp.agg.max_diff.all <- cpt.var(reci_3cp.agg.max_diff.all, method = "BinSeg")
cpts(BS_reci_3cp.agg.max_diff.all)

# plot the location of CPs
plot(reci_3cp.agg.max_diff.all)
abline(v=BS_diff_3cp.agg.max_diff.all@cpts[], col="red")
```
...
- Mean
```{r}
WBS_send_3cp.agg.mean_diff.all <- wbs(send_3cp.agg.mean_diff.all)
changepoints(WBS_send_3cp.agg.mean_diff.all)
plot(WBS_send_3cp.agg.mean_diff.all)
```

```{r}
WBS_diff_3cp.agg.mean_diff.all <- wbs(diff_3cp.agg.mean_diff.all)
changepoints(WBS_diff_3cp.agg.mean_diff.all)
plot(WBS_diff_3cp.agg.mean_diff.all)
```

```{r}
WBS_ine_3cp.agg.mean_diff.all <- wbs(ine_3cp.agg.mean_diff.all)
changepoints(WBS_ine_3cp.agg.mean_diff.all)
plot(WBS_ine_3cp.agg.mean_diff.all)
```

```{r}
WBS_reci_3cp.agg.mean_diff.all <- wbs(reci_3cp.agg.mean_diff.all)
changepoints(WBS_reci_3cp.agg.mean_diff.all)
plot(WBS_reci_3cp.agg.mean_diff.all)
```

- Max
```{r}
WBS_send_3cp.agg.max_diff.all <- wbs(send_3cp.agg.max_diff.all)
changepoints(WBS_send_3cp.agg.max_diff.all)
plot(WBS_send_3cp.agg.max_diff.all)
```

```{r}
WBS_diff_3cp.agg.max_diff.all <- wbs(diff_3cp.agg.max_diff.all)
changepoints(WBS_diff_3cp.agg.max_diff.all)
plot(WBS_diff_3cp.agg.max_diff.all)
```

```{r}
WBS_ine_3cp.agg.max_diff.all <- wbs(ine_3cp.agg.max_diff.all)
changepoints(WBS_ine_3cp.agg.max_diff.all)
plot(WBS_ine_3cp.agg.max_diff.all)
```

```{r}
WBS_reci_3cp.agg.max_diff.all <- wbs(reci_3cp.agg.max_diff.all)
changepoints(WBS_reci_3cp.agg.max_diff.all)
plot(WBS_reci_3cp.agg.max_diff.all)
```
...
```{r}
# compute the mean of top 5% of maximum statistics by timepoints
top_send_3cp_diff.all <- max_mean_time(send_3cp_diff.all, percent = 0.05)$means_max.values_each_timepoint
plot(top_send_3cp_diff.all) # plot it out
```

```{r}
# compute the mean of top 5% of maximum statistics by timepoints
top_diff_3cp_diff.all <- max_mean_time(diff_3cp_diff.all, percent = 0.05)$means_max.values_each_timepoint
plot(top_diff_3cp_diff.all) # plot it out
```

```{r}
# compute the mean of top 5% of maximum statistics by timepoints
top_ine_3cp_diff.all <- max_mean_time(ine_3cp_diff.all, percent = 0.05)$means_max.values_each_timepoint
plot(top_ine_3cp_diff.all) # plot it out
```

```{r}
# compute the mean of top 5% of maximum statistics by timepoints
top_reci_3cp_diff.all <- max_mean_time(reci_3cp_diff.all, percent = 0.05)$means_max.values_each_timepoint
plot(top_reci_3cp_diff.all) # plot it out
```

1. BOCD: Exact CPs Detection Method
```{r}
# test the CPs
BOCD_send_3cp.agg.top_diff.all <- onlineCPD(top_send_3cp_diff.all, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_send_3cp.agg.top_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_send_3cp.agg.top_diff.all)
```

```{r}
# test the CPs
BOCD_diff_3cp.agg.top_diff.all <- onlineCPD(top_diff_3cp_diff.all, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_diff_3cp.agg.top_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_diff_3cp.agg.top_diff.all)
```

```{r}
# test the CPs
BOCD_ine_3cp.agg.top_diff.all <- onlineCPD(top_ine_3cp_diff.all, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_ine_3cp.agg.top_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_ine_3cp.agg.top_diff.all)
```

```{r}
# test the CPs
BOCD_reci_3cp.agg.top_diff.all <- onlineCPD(top_reci_3cp_diff.all, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_reci_3cp.agg.top_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_reci_3cp.agg.top_diff.all)
```

2. PELT: Exact CPs Detection Method
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_send_3cp.agg.top_diff.all <- cpt.var(top_send_3cp_diff.all, method="PELT")
summary(PELT_send_3cp.agg.top_diff.all)

# plot the location of detected CPs
plot(top_send_3cp_diff.all, type="point", col = "black")
abline(v=PELT_ine_3cp.agg.top_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_diff_3cp.agg.top_diff.all <- cpt.var(top_diff_3cp_diff.all, method="PELT")
summary(PELT_diff_3cp.agg.top_diff.all)

# plot the location of detected CPs
plot(top_diff_3cp_diff.all, type="point", col = "black")
abline(v=PELT_diff_3cp.agg.top_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_ine_3cp.agg.top_diff.all <- cpt.var(top_ine_3cp_diff.all, method="PELT")
summary(PELT_ine_3cp.agg.top_diff.all)

# plot the location of detected CPs
plot(top_ine_3cp_diff.all, type="point", col = "black")
abline(v=PELT_ine_3cp.agg.top_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
PELT_reci_3cp.agg.top_diff.all <- cpt.var(top_reci_3cp_diff.all, method="PELT")
summary(PELT_reci_3cp.agg.top_diff.all)

# plot the location of detected CPs
plot(top_reci_3cp_diff.all, type="point", col = "black")
abline(v=PELT_reci_3cp.agg.top_diff.all@cpts[], col="red")
```

3. BS: approximate CPs Detection Method
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_send_3cp.agg.top_diff.all <- cpt.meanvar(top_send_3cp_diff.all, method = "BinSeg")
cpts(BS_send_3cp.agg.top_diff.all)

# plot the location of CPs
plot(top_send_3cp_diff.all)
abline(v=BS_send_3cp.agg.top_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_diff_3cp.agg.top_diff.all <- cpt.meanvar(top_diff_3cp_diff.all, method = "BinSeg")
cpts(BS_diff_3cp.agg.top_diff.all)

# plot the location of CPs
plot(top_diff_3cp_diff.all)
abline(v=BS_diff_3cp.agg.top_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_ine_3cp.agg.top_diff.all <- cpt.meanvar(top_ine_3cp_diff.all, method = "BinSeg")
cpts(BS_ine_3cp.agg.top_diff.all)

# plot the location of CPs
plot(top_ine_3cp_diff.all)
abline(v=BS_ine_3cp.agg.top_diff.all@cpts[], col="red")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_reci_3cp.agg.top_diff.all <- cpt.meanvar(top_reci_3cp_diff.all, method = "BinSeg")
cpts(BS_reci_3cp.agg.top_diff.all)

# plot the location of CPs
plot(top_reci_3cp_diff.all)
abline(v=BS_reci_3cp.agg.top_diff.all@cpts[], col="red")
```

4. Wild BS
```{r}
WBS_send_3cp.agg.top <- wbs(top_send_3cp_diff.all)
changepoints(WBS_send_3cp.agg.top_diff.all)
plot(WBS_send_3cp.agg.top_diff.all)
```

```{r}
WBS_diff_3cp.agg.top <- wbs(top_diff_3cp_diff.all)
changepoints(WBS_diff_3cp.agg.top_diff.all)
plot(WBS_diff_3cp.agg.top_diff.all)
```

```{r}
WBS_ine_3cp.agg.top <- wbs(top_ine_3cp_diff.all)
changepoints(WBS_ine_3cp.agg.top_diff.all)
plot(WBS_ine_3cp.agg.top_diff.all)
```

```{r}
WBS_reci_3cp.agg.top <- wbs(top_reci_3cp_diff.all)
changepoints(WBS_reci_3cp.agg.top_diff.all)
plot(WBS_reci_3cp.agg.top_diff.all)
```
...
```{r}
# extract the synthetic data with 1 CP (data frmae)
reh_3cp_diff.all <- reh_3cp_diff.all[[1]]
```

```{r}
# Save the created REH
saveRDS(object = reh_3cp_diff.all, file = "REH_3CP_diff.all.RDS")
```

1. Step 1: compute the optimal lengths of the windows
```{r}
# obtain data-driven window widths
ddwin_3cp_diff.all <- ddwindows(edgelist = reh_3cp_diff.all, tie_effects = formula, mintime = 2000, 
		covar = covar)
```
...
```{r}
#  fits a moving window relational event model
model_ddwin_3cp_diff.all <- MWrem(windows = ddwin_3cp_diff.all$windows, edgelist = reh_3cp_diff.all, 
		stats = stat.3cp_diff.all, actors = covar$id, directed = TRUE)
```

3. Step 3: extract the parameters by windows and plot them out
```{r}
# extract the parameters
ddmw_send_3cp_param_diff.all <- 1
for (i in 1:length(model_ddwin_3cp_diff.all)) {
  ddmw_send_3cp_param_diff.all[i] <- model_ddwin_3cp_diff.all[[i]][["coefficients"]][["send.z"]]
}
plot(ddmw_send_3cp_param_diff.all, type = "lm") # plot the movement of parameter
```

```{r}
# extract the parameters
ddmw_diff_3cp_param_diff.all <- 1
for (i in 1:length(model_ddwin_3cp_diff.all)) {
  ddmw_diff_3cp_param_diff.all[i] <- model_ddwin_3cp_diff.all[[i]][["coefficients"]][["difference.z"]]
}
plot(ddmw_diff_3cp_param_diff.all, type = "lm") # plot the movement of parameter
```

```{r}
# extract the parameters
ddmw_ine_3cp_param_diff.all <- 1
for (i in 1:length(model_ddwin_3cp_diff.all)) {
  ddmw_ine_3cp_param_diff.all[i] <- model_ddwin_3cp_diff.all[[i]][["coefficients"]][["inertia"]]
}
plot(ddmw_ine_3cp_param_diff.all, type = "lm") # plot the movement of parameter
```

```{r}
# extract the parameters
ddmw_reci_3cp_param_diff.all <- 1
for (i in 1:length(model_ddwin_3cp_diff.all)) {
  ddmw_reci_3cp_param_diff.all[i] <- model_ddwin_3cp_diff.all[[i]][["coefficients"]][["reciprocity"]]
}
plot(ddmw_reci_3cp_param_diff.all, type = "lm") # plot the movement of parameter
```
...
1. BOCD: Exact CPs Detection Method
```{r}
BOCD_ddmw_send_3cp_param_diff.all <- onlineCPD(ddmw_send_3cp_param_diff.all, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_ddmw_send_3cp_param_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_ddmw_send_3cp_param_diff.all)
```

```{r}
BOCD_ddmw_diff_3cp_param_diff.all <- onlineCPD(ddmw_diff_3cp_param_diff.all, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_ddmw_diff_3cp_param_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_ddmw_diff_3cp_param_diff.all)
```

```{r}
BOCD_ddmw_ine_3cp_param_diff.all <- onlineCPD(ddmw_ine_3cp_param_diff.all, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_ddmw_ine_3cp_param_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_ddmw_ine_3cp_param_diff.all)
```

```{r}
BOCD_ddmw_reci_3cp_param_diff.all <- onlineCPD(ddmw_reci_3cp_param_diff.all, getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_ddmw_reci_3cp_param_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_ddmw_reci_3cp_param_diff.all)
```

2. PELT: Exact CPs Detection Method
```{r}
PELT_ddmw_send_3cp_param_diff.all <- cpt.var(ddmw_send_3cp_param_diff.all, method="PELT")
summary(PELT_ddmw_send_3cp_param_diff.all)

# plot the location of CPs
plot(ddmw_send_3cp_param_diff.all, type="l", col = "red")
abline(v=PELT_ddmw_send_3cp_param_diff.all@cpts[], col="black")
```

```{r}
PELT_ddmw_diff_3cp_param_diff.all <- cpt.var(ddmw_diff_3cp_param_diff.all, method="PELT")
summary(PELT_ddmw_diff_3cp_param_diff.all)

# plot the location of CPs
plot(ddmw_diff_3cp_param_diff.all, type="l", col = "red")
abline(v=PELT_ddmw_diff_3cp_param_diff.all@cpts[], col="black")
```

```{r}
PELT_ddmw_ine_3cp_param_diff.all <- cpt.var(ddmw_ine_3cp_param_diff.all, method="PELT")
summary(PELT_ddmw_ine_3cp_param_diff.all)

# plot the location of CPs
plot(ddmw_ine_3cp_param_diff.all, type="l", col = "red")
abline(v=PELT_ddmw_ine_3cp_param_diff.all@cpts[], col="black")
```

```{r}
PELT_ddmw_reci_3cp_param_diff.all <- cpt.var(ddmw_reci_3cp_param_diff.all, method="PELT")
summary(PELT_ddmw_reci_3cp_param_diff.all)

# plot the location of CPs
plot(ddmw_reci_3cp_param_diff.all, type="l", col = "red")
abline(v=PELT_ddmw_reci_3cp_param_diff.all@cpts[], col="black")
```

3. BS: approximate CPs Detection Method
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_ddmw_send_3cp_param_diff.all <- cpt.var(ddmw_send_3cp_param_diff.all, method = "BinSeg")
cpts(BS_ddmw_send_3cp_param_diff.all)

# plot the location of CPs
plot(ddmw_send_3cp_param_diff.all)
abline(v=BS_ddmw_send_3cp_param_diff.all@cpts[], col="black")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_ddmw_diff_3cp_param_diff.all <- cpt.var(ddmw_diff_3cp_param_diff.all, method = "BinSeg")
cpts(BS_ddmw_diff_3cp_param_diff.all)

# plot the location of CPs
plot(ddmw_diff_3cp_param_diff.all)
abline(v=BS_ddmw_diff_3cp_param_diff.all@cpts[], col="black")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_ddmw_ine_3cp_param_diff.all <- cpt.var(ddmw_ine_3cp_param_diff.all, method = "BinSeg")
cpts(BS_ddmw_ine_3cp_param_diff.all)

# plot the location of CPs
plot(ddmw_ine_3cp_param_diff.all)
abline(v=BS_ddmw_ine_3cp_param_diff.all@cpts[], col="black")
```

```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_ddmw_reci_3cp_param_diff.all <- cpt.var(ddmw_reci_3cp_param_diff.all, method = "BinSeg")
cpts(BS_ddmw_reci_3cp_param_diff.all)

# plot the location of CPs
plot(ddmw_reci_3cp_param_diff.all)
abline(v=BS_ddmw_reci_3cp_param_diff.all@cpts[], col="black")
```

4. Wild BS
```{r}
WBS_ddmw_send_3cp_param_diff.all <- wbs(ddmw_send_3cp_param_diff.all)
changepoints(WBS_ddmw_send_3cp_param_diff.all)
plot(WBS_ddmw_send_3cp_param_diff.all)
```

```{r}
WBS_ddmw_diff_3cp_param_diff.all <- wbs(ddmw_diff_3cp_param_diff.all)
changepoints(WBS_ddmw_diff_3cp_param_diff.all)
plot(WBS_ddmw_diff_3cp_param_diff.all)
```

```{r}
WBS_ddmw_ine_3cp_param_diff.all <- wbs(ddmw_ine_3cp_param_diff.all)
changepoints(WBS_ddmw_ine_3cp_param_diff.all)
plot(WBS_ddmw_ine_3cp_param_diff.all)
```

```{r}
WBS_ddmw_reci_3cp_param_diff.all <- wbs(ddmw_reci_3cp_param_diff.all)
changepoints(WBS_ddmw_reci_3cp_param_diff.all)
plot(WBS_ddmw_reci_3cp_param_diff.all)
```
...
4. Wild BS
```{r}
WBS_fixmw_send_3cp_param_diff.all <- wbs(fixmw_send_3cp_param_diff.all)
changepoints(WBS_fixmw_send_3cp_param_diff.all)
plot(WBS_fixmw_send_3cp_param_diff.all)
```

```{r}
WBS_fixmw_diff_3cp_param_diff.all <- wbs(fixmw_diff_3cp_param_diff.all)
changepoints(WBS_fixmw_diff_3cp_param_diff.all)
plot(WBS_fixmw_diff_3cp_param_diff.all)
```

```{r}
WBS_fixmw_ine_3cp_param_diff.all <- wbs(fixmw_ine_3cp_param_diff.all)
changepoints(WBS_fixmw_ine_3cp_param_diff.all)
plot(WBS_fixmw_ine_3cp_param_diff.all)
```

```{r}
WBS_fixmw_out_3cp_param_diff.all <- wbs(fixmw_out_3cp_param_diff.all)
changepoints(WBS_fixmw_out_3cp_param_diff.all)
plot(WBS_fixmw_out_3cp_param_diff.all)
```
