...
# specify the length of the window
windows_1cp_same.all <- REHdynamics::createwindows(1800, tau)
...
```{r}
PELT_fixmw_osp_1cp_param_same.all <- cpt.meanvar(fixmw_osp_1cp_param_same.all, method="PELT")
...
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_fixmw_osp_1cp_param_same.all <- cpt.meanvar(fixmw_osp_1cp_param_same.all, method = "BinSeg")
cpts(BS_fixmw_osp_1cp_param_same.all)

# plot the location of CPs
plot(fixmw_osp_1cp_param_same.all)
abline(v=BS_fixmw_osp_1cp_param_same.all@cpts[], col="red")
```
