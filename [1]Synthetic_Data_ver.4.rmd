...
formula <- ~ 1 + remstats::send("z", covar) + # Exogenous statistics
  ...
  remstats::reciprocity(scaling = "std") # Endogenous statistics
...
# fit to the REM model
model_fixwin_1cp_same.all <- REHdynamics::MWrem(windows, edgelist = reh_1cp_same.all, 
...
```{r}
# extract the parameters
fixmw_reci_1cp_param_same.all <- 1
for (i in 1:length(model_fixwin_1cp_same.all)) {
  fixmw_reci_1cp_param_same.all[i] <- model_fixwin_1cp_same.all[[i]][["coefficients"]][["reciprocity"]]
}
plot(fixmw_reci_1cp_param_same.all, type = "lm") # plot the movement of parameter
```
...
```{r}
BOCD_fixmw_reci_1cp_param_same.all <- onlineCPD(fixmw_reci_1cp_param_same.all, 
                                               getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_fixmw_reci_1cp_param_same.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_fixmw_reci_1cp_param_same.all)
```

2. PELT: Exact CPs Detection Method
```{r}
PELT_fixmw_send_1cp_param_same.all <- cpt.var(fixmw_send_1cp_param_same.all, method="PELT")
...
```{r}
PELT_fixmw_diff_1cp_param_same.all <- cpt.var(fixmw_diff_1cp_param_same.all, method="PELT")
...
```{r}
PELT_fixmw_ine_1cp_param_same.all <- cpt.var(fixmw_ine_1cp_param_same.all, method="PELT")
...
```{r}
PELT_fixmw_reci_1cp_param_same.all <- cpt.var(fixmw_reci_1cp_param_same.all, method="PELT")
summary(PELT_fixmw_reci_1cp_param_same.all)

# plot the location of CPs
plot(fixmw_reci_1cp_param_same.all, type="l", col = "red")
abline(v=PELT_fixmw_reci_1cp_param_same.all@cpts[], col="black")
```
...
```{r}
# extract the parameters
fixmw_reci_1cp_param_diff.all <- 1
for (i in 1:length(model_fixwin_1cp_diff.all)) {
  fixmw_reci_1cp_param_diff.all[i] <- model_fixwin_1cp_diff.all[[i]][["coefficients"]][["reciprocity"]]
}
plot(fixmw_reci_1cp_param_diff.all, type = "lm") # plot the movement of parameter
```
...
```{r}
BOCD_fixmw_reci_1cp_param_diff.all <- onlineCPD(fixmw_reci_1cp_param_diff.all, 
                                               getR = T, optionalOutputs = T, truncRlim = 10^-4)
BOCD_fixmw_reci_1cp_param_diff.all[["changepoint_lists"]][["maxCPs"]][[1]]
plot(BOCD_fixmw_reci_1cp_param_diff.all)
```
...
```{r}
PELT_fixmw_reci_1cp_param_diff.all <- cpt.var(fixmw_reci_1cp_param_diff.all, method="PELT")
summary(PELT_fixmw_reci_1cp_param_diff.all)

# plot the location of CPs
plot(fixmw_reci_1cp_param_diff.all, type="l", col = "red")
abline(v=PELT_fixmw_reci_1cp_param_diff.all@cpts[], col="black")
```
...
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_fixmw_reci_1cp_param_diff.all <- cpt.meanvar(fixmw_reci_1cp_param_diff.all, method = "BinSeg")
cpts(BS_fixmw_reci_1cp_param_diff.all)

# plot the location of CPs
plot(fixmw_reci_1cp_param_diff.all)
abline(v=BS_fixmw_reci_1cp_param_diff.all@cpts[], col="red")
```
...
```{r}
WBS_fixmw_reci_1cp_param_diff.all <- wbs(fixmw_reci_1cp_param_diff.all)
changepoints(WBS_fixmw_reci_1cp_param_diff.all)
plot(WBS_fixmw_reci_1cp_param_diff.all)
```
...
```{r}
# cpt.meanvar -> find changes in both mean and variance for data
BS_fixmw_ine_scp_param <- cpt.var(fixmw_ine_scp_param, method = "BinSeg")
